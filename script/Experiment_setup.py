...
experiment_folder = input('Give a name for the new drugscreen folder (don\'t use spaces)')
...
def folder_set_up(experiment_folder):
    ...
    if use_stand_cond == 'y' or use_stand_cond == 'Y':
        os.system(f'cp ../resources/Conditions_table_synergy.xlsx ../{experiment_folder}/input/Conditions_table.xlsx')
        print(f'Added Conditions_table.xlsx to {experiment_folder}/input')
